                  ...
                  <table className="min-w-full">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="px-2 py-1.5 text-left text-xs font-medium text-gray-800">Platform</th>
                        <th className="px-2 py-1.5 text-left text-xs font-medium text-gray-800">Source Entity</th>
                        <th className="px-2 py-1.5 text-left text-xs font-medium text-gray-800">Source URL</th>
                      </tr>
                    </thead>
                    <tbody>
                      {platforms.map((platform, idx) => (
                        <tr key={idx} className="border-b border-gray-200">
                          <td className="px-2 py-1.5 text-xs text-gray-800">{platform.name}</td>
                          <td className="px-2 py-1.5 text-xs text-gray-800">{platform.source}</td>
